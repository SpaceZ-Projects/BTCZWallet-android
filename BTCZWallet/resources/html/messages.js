...
chatContainer.addEventListener('click', (e) => {
  ...
  if (link) {
    ...
    if (window.AndroidBridge && window.AndroidBridge.postMessage) {
      const payload = JSON.stringify({ action: "urlClicked", url: url });
    ...
    //if (editBtn) {
      //editBtn.addEventListener('click', (e) => {
        ...
        //if (isEditing) {
          ...
          //if (window.AndroidBridge && window.AndroidBridge.postMessage) {
            //const payload = JSON.stringify({ action: "edit", content: contentToEdit, timestamp });
            //window.AndroidBridge.postMessage(payload);
          //}
        //} else {
          //editBtn.title = 'Edit';
          ...
          //if (window.AndroidBridge && window.AndroidBridge.postMessage) {
            //const payload = JSON.stringify({ action: "cancelEdit" });
            //window.AndroidBridge.postMessage(payload);
          //}
        //}
      //});
    ...
    //if (replyBtn) {
      //replyBtn.addEventListener('click', (e) => {
        ...
        //if (isReplying) {
          ...
          //if (window.AndroidBridge && window.AndroidBridge.postMessage) {
            //window.AndroidBridge.postMessage(JSON.stringify(replyData));
          //}
        ...
        //} else {
          ...
          //if (window.AndroidBridge && window.AndroidBridge.postMessage) {
            //const payload = JSON.stringify({ action: "cancelReply" });
...
function showUnreadLabel() {
  ...
  if (canScroll) {
    ...
    if (window.AndroidBridge && window.AndroidBridge.postMessage) {
    const payload = JSON.stringify({ action: "scrolledToBottom" });
    window.AndroidBridge.postMessage(payload);
  }
  }
}
...
onScrollToTop = function() {
  if (window.AndroidBridge && window.AndroidBridge.postMessage) {
    const payload = JSON.stringify({ action: "scrolledToTop" });
    window.AndroidBridge.postMessage(payload);
  }
};
